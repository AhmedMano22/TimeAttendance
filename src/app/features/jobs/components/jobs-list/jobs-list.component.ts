...
export class JobsListComponent {
  ...
  onSubmit(modal: any) {
    ...
    if (this.JobForm.valid) {
      ...
      this.apiSer.addJob(formData).subscribe({
        next: (res: any) => {
          console.log(res);
        ...
        swalWithBootstrapButtons
          ...
          .then((result: any) => {
            if (result.isConfirmed) {
              this.apiSer.deleteJob(id).subscribe({
                next: (res: any) => {
                  console.log(res);
  ...
  EditModal(content: any, id: any) {
    ...
    this.apiSer.getJobByID(id).subscribe({
      next: (res: any) => {
        console.log(res);
        if (res.success) {
          this.job = {
  ...
  onSubmitEdit(modal: any) {
    ...
    if (this.EditJobForm.valid) {
      ...
      this.apiSer.UpdateJob(body).subscribe({
        next: (res: any) => {
