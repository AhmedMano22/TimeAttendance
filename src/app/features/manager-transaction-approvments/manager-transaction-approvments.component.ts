...
@Component({
  selector: 'app-manager-transaction-approvments',
  templateUrl: './manager-transaction-approvments.component.html',
  styleUrls: ['./manager-transaction-approvments.component.scss'],
  animations: [slider]
})
export class ManagerTransactionApprovmentsComponent {
  footerDark: boolean;
  footerLight: boolean;
  footerFix: boolean;
  Scorlled: boolean;
