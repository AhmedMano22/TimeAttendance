...
@Component({
  selector: 'app-exception-working-time',
  templateUrl: './exception-working-time.component.html',
  styleUrls: ['./exception-working-time.component.scss'],
  animations: [slider]
})
export class ExceptionWorkingTimeComponent {
  footerDark: boolean;
  footerLight: boolean;
  footerFix: boolean;
  Scorlled: boolean;
